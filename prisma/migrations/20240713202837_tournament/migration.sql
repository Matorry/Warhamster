...
-- AddForeignKey
ALTER TABLE "TournamentParticipant" ADD CONSTRAINT "TournamentParticipant_armyListId_fkey" FOREIGN KEY ("armyListId") REFERENCES "ArmyList"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
